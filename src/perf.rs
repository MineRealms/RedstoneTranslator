...
pub fn print_summary_if_enabled() {
    ...
    let rss = refresh_peak_rss()
        ...
        .unwrap_or_else(|| "n/a".to_owned());
    eprintln!(
        "[perf] summary clones={} clone_bytes={} layer_copies={} layer_copy_bytes={} alloc_bytes={} candidate_truth_rejects={} candidate_port_rejects={} candidate_drc_violations={} peak_rss={} budget={} exceeded={}",
        world_clone_count(),
        world_clone_bytes(),
        layer_copy_count(),
        layer_copy_bytes(),
